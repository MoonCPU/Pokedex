    ...
    return(
        ...
        >
            <div className="mt-4">
                ...
                <div className="max-w-sm mt-10 text-left mx-auto text-lg px-5">
                ...
                <div className="flex items-center justify-center mb-4">
                    <a href="https://github.com/MoonCPU/Pokedex" target="_blank">
                        <AiFillGithub size={80}/>    
                    </a>
                </div>
                
                <p className="mx-auto my-2 text-[5px]">PS. Charizard is overrated. Blastoise or Venusaur are much cooler.</p>
            </div>
        </motion.div>
    )
}
